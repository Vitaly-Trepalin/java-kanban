...
public class PrioritizedHandlerTest {
    ...
    void checkGetPrioritizedTasks() throws IOException, InterruptedException {
        ...
        assertEquals(expectedResult, httpResponse.body(), "Получен неправильный порядок приоритета задач");
    }
}
